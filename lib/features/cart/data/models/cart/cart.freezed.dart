...
abstract class $CartModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, List<CartItem> items});
}
...
class _$CartModelImpl implements _CartModel {
  const _$CartModelImpl(
      {required this.id, final List<CartItem> items = const <CartItem>[]})
      : _items = items;
...
abstract class _CartModel implements CartModel {
  const factory _CartModel(
      {required final String id, final List<CartItem> items}) = _$CartModelImpl;
